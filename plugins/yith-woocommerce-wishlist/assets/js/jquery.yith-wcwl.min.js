jQuery(function(d) {
    ...
    function e() {
        ...
        d('a[data-rel="prettyPhoto[move_to_another_wishlist]"]').on("click", function() {
            var t = d(this)
              , e = d("#move_to_another_wishlist").find("form")
              , i = e.find(".row-id")
              , t = t.closest("[data-row-id]").data("row-id");
            i.length && i.remove(),
            e.append('<input type="hidden" name="row_id" class="row-id" value="' + t + '"/>')
        }).prettyPhoto(t),
        e = function(t, e) {
            "undefined" != typeof t.classList && t.classList.contains("yith-wcwl-overlay") && (e = "remove" === e ? "removeClass" : "addClass",
        ...
        new MutationObserver(function(t) {
            for (var e in t) {
                e = t[e];
                "childList" === e.type && ("undefined" != typeof e.addedNodes && "function" == typeof e.addedNodes.forEach && e.addedNodes.forEach(i),
    ...
    function o() {
        yith_wcwl_l10n.enable_tooltip && d(".yith-wcwl-add-to-wishlist").find("[data-title]").each(function() {
            ...
            t.hasClass("tooltip-added") || (t.on("mouseenter", function() {
                var t, e = d(this), i = null, n = e.outerWidth(), a = 0, i = d("<span>", {
    ...
    function w() {
        d(".copy-trigger").on("click", function() {
            var t = d(".copy-target");
            0 < t.length && (t.is("input") ? (s() ? t[0].setSelectionRange(0, 9999) : t.select(),
            document.execCommand("copy")) : (t = d("<input/>", {
                val: t.text(),
                type: "text"
            }),
            d("body").append(t),
    ...
    function f() {
        d(".wishlist_table").filter(".images_grid").not(".enhanced").on("click", "[data-row-id] .product-thumbnail a", function(t) {
            var e, i, n;
            yith_wcwl_l10n.disable_popup_grid_view || (i = (e = d(this).closest("[data-row-id]")).siblings("[data-row-id]"),
            n = e.find(".item-details"),
            t.preventDefault(),
            n.length && (i.removeClass("show"),
            e.toggleClass("show")))
        }).on("click", "[data-row-id] a.close", function(t) {
            var e = d(this).closest("[data-row-id]")
              , i = e.find(".item-details");
            t.preventDefault(),
            i.length && e.removeClass("show")
        ...
        d(document).on("click", function(t) {
    ...
    function p(e, t, i) {
        ...
        e.context = "frontend",
        "" !== e.wishlist_token && "" !== e.destination_wishlist_token && "" !== e.item_id && d.ajax({
            beforeSend: t,
            url: yith_wcwl_l10n.ajax_url,
            data: e,
            dataType: "json",
            ...
            success: function(t) {
                i(t),
                c(),
                d("body").trigger("moved_to_another_wishlist", [d(this), e.item_id])
            }
        })
    }
    function u(e) {
    ...
    function m(t) {
        var e = d(this)
          ...
          , n = null;
        t.preventDefault(),
        (n = i.length ? e.closest("[data-wishlist-id]").find(".wishlist-title") : e.parents(".wishlist-title")).next().css("display", "inline-block").find('input[type="text"]').focus(),
        n.hide()
    }
    function y(t) {
        var e = d(this);
    ...
    function v(t) {
        ...
        if (t.preventDefault(),
        !o)
            return i.addClass("woocommerce-invalid"),
            void a.focus();
        ...
        d.ajax({
            ...
            success: function(t) {
                var e = t.fragments;
                t.result ? (i.hide(),
                i.prev().find(".wishlist-anchor, h1, h2").text(o).end().show()) : (i.addClass("woocommerce-invalid"),
                a.focus()),
                void 0 !== e && O(e),
                c()
            }
    ...
    function b(t, e) {
        if ("undefined" != typeof d.prettyPhoto && "undefined" != typeof d.prettyPhoto.close)
            if (void 0 !== t) {
                var i, n = d(".pp_content_container"), a = n.find(".pp_content"), o = n.find(".yith-wcwl-popup-form"), n = o.closest(".pp_pic_holder");
                o.length && ((i = d("<div/>", {
                ...
                try {
                    d.prettyPhoto.close(),
                    yith_wcwl_l10n.redirect_after_ask_estimate && window.location.replace(yith_wcwl_l10n.ask_estimate_redirect_url)
                } catch (s) {}
    }
    function x(t) {
        ...
        "undefined" != typeof yith_wcwl_l10n.enable_notices && !yith_wcwl_l10n.enable_notices || (i.html(t),
    ...
    function S(t) {
        ...
        t.firstLoad && (e = e.filter(".on-first-load"))) : (e = d(".wishlist-fragment"),
    ...
    function P(e) {
        ...
        i && d.ajax({
            ...
            success: function(t) {
                "undefined" != typeof t.fragments && (O(t.fragments),
                c(),
                d(document).trigger("yith_wcwl_fragments_loaded", [i, t.fragments, e.firstLoad]))
            },
            url: yith_wcwl_l10n.ajax_url
        })
    }
    function O(t) {
        d.each(t, function(t, e) {
            var i = "." + t.split(yith_wcwl_l10n.fragments_index_glue).filter(t=>t.length && "exists" !== t && "with-count" !== t).join(".")
              , n = d(i)
              , t = d(e).filter(i);
            t.length || (t = d(e).find(i)),
            n.length && t.length && n.replaceWith(t)
        })
    }
    function s() {
    ...
    d(document).on("yith_wcwl_init", function() {
        var l, t = d(this), s = "undefined" != typeof wc_add_to_cart_params && null !== wc_add_to_cart_params ? wc_add_to_cart_params.cart_redirect_after_add : "";
        t.on("click", ".add_to_wishlist", function(t) {
            ...
            if ((i = d(document).triggerHandler("yith_wcwl_add_to_wishlist_data", [n, o])) && (o = i),
            t.preventDefault(),
            ...
            yith_wcwl_l10n.multi_wishlist && yith_wcwl_l10n.modal_enable) {
                ...
                if (o.wishlist_id = i.is(":visible") ? i.val() : "new",
            ...
            if (T())
                return d.ajax({
                    ...
                    success: function(t) {
                        var e = t.result
                          , i = t.message;
                        yith_wcwl_l10n.multi_wishlist ? (b(i, e),
                        "undefined" != typeof t.user_wishlists && k(t.user_wishlists)) : x(i),
                        "true" !== e && "exists" !== e || ("undefined" != typeof t.fragments && O(t.fragments),
                        yith_wcwl_l10n.multi_wishlist && !yith_wcwl_l10n.hide_add_button || a.find(".yith-wcwl-add-button").remove(),
                        a.addClass("exists")),
                        c(),
        ...
        t.on("adding_to_cart", "body", function(t, e, i) {
            void 0 !== e && void 0 !== i && e.closest(".wishlist_table").length && (i.remove_from_wishlist_after_add_to_cart = e.closest("[data-row-id]").data("row-id"),
        ...
        t.on("click", ".yith-wcwl-popup-footer .move_to_wishlist", function() {
            ...
            if ("new" === a && !s)
                return o.closest("p").addClass("woocommerce-invalid"),
                !1;
            ...
            p({
                ...
                var e = t.message;
                yith_wcwl_l10n.multi_wishlist ? (b(e),
                "undefined" != typeof t.user_wishlists && k(t.user_wishlists)) : x(e),
                "undefined" != typeof t.fragments && O(t.fragments),
                c(),
                C(i)
            })
        ...
        t.on("submit", ".wishlist-ask-an-estimate-popup", function() {
            var t = d(this)
              ...
              , t = i.serializeArray().reduce((t,e)=>(t[e.name] = e.value,
            t), {});
            ...
            d.ajax({
                ...
                success: function(t) {
                    var e;
                    "undefined" != typeof t.result && t.result ? void 0 !== (e = t.template) && (i.replaceWith(e),
                    n.css("height", "auto"),
                    setTimeout(b, yith_wcwl_l10n.time_to_close_prettyphoto)) : "undefined" != typeof t.message && (i.find(".woocommerce-error").remove(),
        ...
        t.on("found_variation", function(t, e) {
            ...
            i && n && t.length && (t.each(function() {
                ...
                e.length && (void 0 !== (t = e.data("fragment-options")) && (t.product_id = n,
                e.data("fragment-options", t)),
                e.removeClass(function(t, e) {
                    return e.match(/add-to-wishlist-\S+/g).join(" ")
                }).addClass("add-to-wishlist-" + n).attr("data-fragment-ref", n))
            }),
            yith_wcwl_l10n.reload_on_found_variation && (j(e),
            P({
                fragments: e,
                firstLoad: !1
            })))
        ...
        t.on("reset_data", function(t) {
            ...
            yith_wcwl_l10n.reload_on_found_variation && (j(t),
            P({
                fragments: t,
                firstLoad: !1
            })))
        ...
        "undefined" != typeof yith_wcwl_l10n.enable_notices && !yith_wcwl_l10n.enable_notices || !d(".yith-wcwl-add-to-wishlist").length || d("#yith-wcwl-popup-message").length || (t = d("<div>").attr("id", "yith-wcwl-message"),
        ...
        n(),
        l = !1,
        yith_wcwl_l10n.is_wishlist_responsive && d(window).on("resize", function() {
            var t = d(".wishlist_table.responsive")
              ...
              , s = {}
              , n = !1;
            t.length && (i.matches && t && !e ? (o.is_mobile = "yes",
            n = !0) : !i.matches && t && e && (o.is_mobile = "no",
            n = !0),
            n && (l && l.abort(),
            ...
            l = d.ajax({
                ...
                success: function(t) {
                    "undefined" != typeof t.fragments && (O(t.fragments),
                    c(),
                    d(document).trigger("yith_wcwl_responsive_template", [e, t.fragments]))
                },
                url: yith_wcwl_l10n.ajax_url
            })))
        }),
