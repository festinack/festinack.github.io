...
function(e) {
    ...
    _.extend(wp.Backbone.Subviews.prototype, {
        ...
        set: function(i, e, t) {
            var n, s;
            return _.isString(i) || (t = e,
            e = i,
            i = ""),
            t = t || {},
            s = e = _.isArray(e) ? e : [e],
            (n = this.get(i)) && (t.add ? _.isUndefined(t.at) ? s = n.concat(e) : (s = n).splice.apply(s, [t.at, 0].concat(e)) : (_.each(s, function(e) {
                e.__detach = !0
            }),
            _.each(n, function(e) {
            ...
            t.silent || this._attach(i, e, _.extend({
                ready: this._isReady()
            }, t)),
            this
        },
        ...
        insert: function(e, t, i) {
            var n, i = i && i.at;
            return _.isNumber(i) && (n = e.children()).length > i ? n.eq(i).before(t) : e.append(t),
            this
        },
        ready: function() {
        ...
        _attach: function(e, t, i) {
            var n, e = e ? this.view.$(e) : this.view.$el;
            return e.length && (n = _.chain(t).pluck("views").flatten().value(),
            _.each(n, function(e) {
    ...
    wp.Backbone.View = Backbone.View.extend({
        ...
        render: function() {
            ...
            this.views.detach(),
            this.template && (this.trigger("prepare", e = e || {}),
